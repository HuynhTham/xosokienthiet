...
<%--        var northernListSize = ${northernList.size()}; // Thay "${northernList.size()}" bằng biến thực tế trong ứng dụng của bạn--%>
<%--        var southernListSize = ${southernList.size()}; // Thay "${southernList.size()}" bằng biến thực tế trong ứng dụng của bạn--%>
<%--        var centralListSize = ${centralList.size()}; // Thay "${centralList.size()}" bằng biến thực tế trong ứng dụng của bạn--%>

<%--        if (northernListSize !== undefined) {--%>
<%--            var divMiennam = document.getElementById('miennam'); // Thay 'miennam' bằng ID của thẻ div bạn muốn thêm class--%>
<%--            var divMientrung = document.getElementById('mientrung'); // Thay 'mientrung' bằng ID của thẻ div bạn muốn thêm class--%>

<%--            if (divMiennam) {--%>
<%--                var newClassMiennam = 'xosomiennam_' + northernListSize;--%>
<%--                divMiennam.classList.add(newClassMiennam);--%>
<%--            }--%>

<%--            if (divMientrung) {--%>
<%--                var newClassMientrung = 'xosomiennam_' + centralListSize; // Chú ý: tôi sử dụng centralListSize ở đây, hãy thay đổi nếu cần thiết--%>
<%--                divMientrung.classList.add(newClassMientrung);--%>
<%--            }--%>
<%--        }--%>
<%--    });--%>
<%--</script>--%>
